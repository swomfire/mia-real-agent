...
export const CONVERSATION_STATUS = {
  OPEN: 'OPEN',
  CLOSE: 'CLOSE',
  SUPPORT_FULLFIL: 'SUPPORT_FULLFIL',
  SUPPORT_UNFULLFIL: 'SUPPORT_UNFULLFIL',
};
...
export const REPLY_TYPE = {
  ...
  USER_ACTION_BUTTON: 'USER_ACTION_BUTTON',
...
export const REPLY_USER_ACTION = {
  ...
  REQUEST_END: 'Request end support',
...
export const SOCKET_EMIT = {
  ...
  REQUEST_SUPPORT_AVAILABLE: 'REQUEST_SUPPORT_AVAILABLE',
  REQUEST_SUPPORT_CONFIRM: 'REQUEST_SUPPORT_CONFIRM',
  REMOVE_REQUEST_SUPPORT: 'REMOVE_REQUEST_SUPPORT',
  REQUEST_SUPPORT_END: 'REQUEST_SUPPORT_END',
  CONFIRM_END_SUPPORT: 'CONFIRM_END_SUPPORT',
